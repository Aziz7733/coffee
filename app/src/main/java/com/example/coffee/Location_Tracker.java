...
public class Location_Tracker extends Service implements LocationListener {
    ...
    private static final long MIN_DISTANCE_CHANGE_FOR_UPDATES = 100; //It updates the location for a distance difference of 100 meters.
    ...
    Location location; // location هذا المتغير يحصل على الموقع الحالي في دالة getLocation
    ...
    //هذه الدالة تقوم بايجاد الموقع الحالي
